...
for yyy = weightFactor
    ...
    for zzz = 1:repetitions
        ...
        PARAMS.factorEI =yyy;
        PARAMS.factorIE =yyy;
        PARAMS.pfactorEI = yyy;%2.5;
        PARAMS.pfactorIE = yyy;%2.5;
        ...
        % get weight matrix
        [weightsEE, weightsEI, weightsIE, weightsII] = create_EI_topology(EneuronNum,numClusters,PARAMS);
        %simluate raster
    ...
    save('ParameterSweepEI_5seconds')
end
